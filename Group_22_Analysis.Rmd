...
#summ(model_full)
#AIC= 292.66, BIC= 382.72, least significant term Sellable_online with p-value 0.99
...
#summ(model2)
#AIC= 291.437, BIC= 377.34, least significant term category with p-values 0.99
...
#summ(model3)
#AIC 312.97, BIC 333.44, least significant term other_colors with p-value 0.07
...
Hence, the log-odds of the price being expensive increase by 0.01 for every one unit increase in height, 0.02 for width, 0.05 for depth. And the depth is the most important variable for price over 1000 Saudi Riyals.
